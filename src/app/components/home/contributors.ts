...
export const decoBubblesTeam: Contributor[] = [
  {
    name: 'Martin Smolka',
    bio: `Martin is a Senior at The University Of North Carolina at Chapel Hill where he is finishing up his bachelor’s in computer science. Martin has experience with building modern web applications and works as an undergraduate researcher on Dr. Papadopoulou's team to build and maintain DecoBubbles. When building DecoBubbles, Martin had the challenge of converting the proven MatLab based bubble counting GUI to the web to allow for crowdsourcing. He designed and developed DecoBubbles using Google’s Angular Framework and developed the structure of the database in Firebase.`,
    title: 'Web Developer',
    picture: 'martin.jpg',
  ...
  },
  {
    ...
    title: 'AI Developer',
    picture: 'david.jpg',
    linkedIn: 'https://www.linkedin.com/in/david-le-bme/'
  },
  {
...
export const collaborators: Contributor[] = [
  {
    ...
    picture: 'costantino.jpg',
  },
  {
    name: 'Peter Buzzacott',
    bio: `Dr Peter Buzzacott, MPH, PhD, FUHM, is a senior research fellow at Curtin University in Western Australia, and an active recreational diver, in particular technical, cave and rebreather diving. Dr Buzzacott has published more than 60 scientific papers in medical journals, many focussed on decompression physiology. His current interests include predictive modelling, of either decompression sickness or bubbles, and fitness for scuba diving.`,
    picture: 'Buzzacott.jpg'
  },
  {
    name: 'Peter Germonpré',
    bio: `Dr Peter Germonpré, MD has been involved in diving and hyperbaric medicine for over 30 years, as head of the hyperbaric medicine department of the Military Hospital in Brussels, Belgium and as DAN Europe Medical Director for the Dutch and French speaking areas. He has published multiple scientific papers on decompression sickness and bubble detection.`,
    picture: 'peter.jpg',
  },
];
